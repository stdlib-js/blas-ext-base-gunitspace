...
```javascript
import gunitspace from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gunitspace@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gunitspace@deno/mod.js';
```
